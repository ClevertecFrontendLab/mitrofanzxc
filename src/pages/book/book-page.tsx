...
import { BreadCrumbs, ButtonPrimary, Nav, Rating, Review, Slider, Table } from '../../components';
        ...
        <div className='book-page'>
          ...
          <div className='book-page__info'>
            ...
            {bookInfo && bookInfo.status.message === 'busy' && (
              <ButtonPrimary
                type='secondary'
                title={`Занята до ${bookInfo.status.timestamp && convertToDate(bookInfo.status.timestamp, 'short')}`}
